        ...
        <div className="about-text">
          ...
          <div className="about-paragraphs">
            <p className="about-paragraph">
              A <span className="bold">Primeira Igreja Batista no Retiro</span> em 2024 completa 
              <span className="bold"> 20 anos</span> de fundação. Temos como Igreja de Cristo o propósito 
              de ser uma agência do Reino de Deus para servir ao Senhor e 
              <span className="bold"> levar Sua Palavra com amor e fé</span>, buscando ser um ambiente 
              que propicie o <span className="bold">crescimento espiritual e mental dos seus membros</span>.
            </p>

            <p className="about-paragraph">
              Você é <span className="bold">bem-vindo(a)</span> para estar conosco e, através do 
              Estudo da Palavra, louvores, orações e comunhão, crescer e viver as 
